...
using TeslaSoft.Models.TokenAuth;
...
{
    public abstract class TeslaSoftWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TeslaSoftWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TeslaSoftWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TeslaSoftDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TeslaSoftDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TeslaSoftDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TeslaSoftDbContext, Task<T>> func)
        {
            T result;
